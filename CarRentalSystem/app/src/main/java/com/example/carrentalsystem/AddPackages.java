    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                MyAdapter adapter = new MyAdapter(AddPackages.this, R.layout.custom_add_package, (ArrayList<VehiclesDetails>) user);
    ...
    class MyAdapter extends ArrayAdapter<VehiclesDetails> {
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            if (view == null) {
                ...
                view = inflater.inflate(R.layout.custom_add_package, null);
                ...
                holder.button1 = (Button) view.findViewById(R.id.add);
            ...
            holder.button1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i = new Intent(AddPackages.this,SavePackage.class);
                    i.putExtra("id",user.get(position).getId());
                    i.putExtra("number",user.get(position).getVehicleNo());
                    i.putExtra("model",user.get(position).getModel());
                    i.putExtra("brand",user.get(position).getBrand());
